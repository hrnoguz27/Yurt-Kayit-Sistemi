...
namespace YurtKayitSistemi
{
    public partial class FrmOgrListe : Form
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            fr.dt = dataGridView1.Rows[secilen].Cells[5].Value.ToString();
            ...
            fr.vad = dataGridView1.Rows[secilen].Cells[9].Value.ToString();
            fr.vtelefon = dataGridView1.Rows[secilen].Cells[10].Value.ToString();
